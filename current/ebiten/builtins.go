...
var Builtins = map[string]*env.Builtin{
	...
	"image": {
		Doc: "Create a new ebiten.Image struct",
		Argsn: 0,
		Fn: func(ps *env.ProgramState, arg0, arg1, arg2, arg3, arg4 env.Object) env.Object {
			res := &ebiten.Image{}
			var resObj env.Object
			resObj = *env.NewNative(ps.Idx, res, "ptr-ebiten-image")
			return resObj
		},
	},
	"run-game-options": {
	...
	"ebitenutil-image-from-file-system": {
		...
		Fn: func(ps *env.ProgramState, arg0, arg1, arg2, arg3, arg4 env.Object) env.Object {
			...
			case env.RyeCtx:
				...
				if err != nil {
					ps.FailureFlag = true
					return env.NewError("ebitenutil-image-from-file-system: arg 1: "+err.Error()+"")
				}
			case env.Native:
				var ok bool
	...
	"ebitenutil-image-from-reader": {
		...
		Fn: func(ps *env.ProgramState, arg0, arg1, arg2, arg3, arg4 env.Object) env.Object {
			...
			case env.RyeCtx:
				...
				if err != nil {
					ps.FailureFlag = true
					return env.NewError("ebitenutil-image-from-reader: arg 1: "+err.Error()+"")
				}
			case env.Native:
				var ok bool
